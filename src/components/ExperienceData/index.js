    ...
    <>
      ...
      <div className="experience__content">
        ...
        <BgGrid id="experience__data">
          ...
          <p className="experience__description">
            Atuei como Analista de Negócios na elaboração da documentação de um dos projetos.
            Realizei pesquisas, analisando as operações do serviço, através de reuniões com os colaboradores, stakeholders e cliente. Ao lado dos mesmos modelei e documentei o serviço. Elaborando também o diagrama dos processos de atendimento, sempre mantendo a comunicação transparente para cumprir os prazos.
          </p>
        </BgGrid>
      </div>
      ...
      <div className="experience__content">
        ...
        <BgGrid id="experience__data">
          ...
          <p className="experience__description">
            Atuei como desenvolvedora backend em um projeto internacional. Sendo responsável por auxiliar na manutenção de sistemas, utilizando JavaScript e Typescript como principais linguagens de programação e ferramentas como puppeteer e Git para versionamento. Além de utilizar a metodologia ágil Scrum
          </p>
        </BgGrid>
      </div>
    </>
